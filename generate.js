...
const lyricSets = {};
const titles = ["Epic", "Hamilton", "Heathers", "The Mad Ones", "Six", "Hazbin Hotel Season 1", "Hazbin Hotel Season 2"];
...
const files = ["epic", "hamilton", "heathers", "mad_ones", "six", "hazbin1", "hazbin2"];
const dir = "./albums";
